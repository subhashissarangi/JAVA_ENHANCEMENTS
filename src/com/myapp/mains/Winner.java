...
public class Winner {
	...
	public static void main(String args[]) {
		...
		List<String> winnersOfToursLessThan3500km = tdfWinners.stream().filter(d -> d.getLengthKm() < 3500) // Separate
																											// out Tours
																											// less than
																											// 3500km
		...
		// Winners of Tours Less than 3500km - [Alberto Contador, Cadel Evans, Bradley
		// Wiggins, Chris Froome, Chris Froome]

		System.out.println("Winners of Tours Less than 3500km - " + winnersOfToursLessThan3500km);

		List<String> winnersOfToursGreaterThan3500km = tdfWinners.stream().filter(d -> d.getLengthKm() >= 3500)
				.map(Winner::getName).collect(toList());

		// Winners of Tours Greater than 3500km - [Óscar Pereiro, Alberto Contador,
		// Carlos Sastre, Andy Schleck, Vincenzo Nibali, Chris Froome]

		System.out.println("Winners of Tours Greater than 3500km - " + winnersOfToursGreaterThan3500km);

		// limit -

		List<Winner> winnerObjectsOfToursLessThan3500kmLimit2 = tdfWinners.stream().filter(d -> d.getLengthKm() < 3500)
		...
		List<String> firstTwoWinnersOfToursLessThan3500km = tdfWinners.
				stream().filter(d -> d.getLengthKm() < 3500)
				.map(Winner::getName)
				.limit(2)
				.collect(toList());
		...
		// skipEveryOtherTDFWinner - [Carlos Sastre, Alberto Contador, Andy Schleck,
		// Cadel Evans, Bradley Wiggins, Chris Froome, Vincenzo Nibali, Chris Froome,
		// Chris Froome]
		...
		// mapWinnerYearNamesToList [2006 - Óscar Pereiro, 2007 - Alberto Contador, 2008
		// - Carlos Sastre, 2009 - Alberto Contador, 2010 - Andy Schleck, 2011 - Cadel
		...
		// namesVsWinner - {Bradley Wiggins=[Bradley Wiggins], Carlos Sastre=[Carlos
		// Sastre], Cadel Evans=[Cadel Evans], Óscar Pereiro=[Óscar Pereiro], Chris
		// Froome=[Chris Froome, Chris Froome, Chris Froome], Andy Schleck=[Andy
		// Schleck], Alberto Contador=[Alberto Contador, Alberto Contador], Vincenzo
		...
		// allTDFWinnersTeams Caisse d'Epargne–Illes Balears, Discovery Channel, Team
		// CSC, Astana, Team Saxo Bank, BMC Racing Team, Team Sky, Team Sky, Astana,
		// Team Sky, Team Sky
		...
		// winnersByNationality - {Great Britain=[Bradley Wiggins, Chris Froome, Chris
		// Froome, Chris Froome], Luxembourg=[Andy Schleck], Italy=[Vincenzo Nibali],
		// Australia=[Cadel Evans], Spain=[Óscar Pereiro, Alberto Contador, Carlos
		// Sastre, Alberto Contador]}
